...
Validates the GrowthBook SDK v1.4.1 by running **actual BrightScript code** against the official spec test suite (`cases.json`) inside [brs-desktop](https://github.com/lvcabral/brs-desktop).
